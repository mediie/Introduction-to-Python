...
My completed solutions to the [Introduction to Python](https://github.com/jetbrains-academy/introduction_to_python) course by JetBrains Academy. The course material is MIT licensed, see [LICENSE](./LICENSE). Everything below is the original course README.
